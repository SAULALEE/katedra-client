...
- **Core Stack:** React 18+ with shadcn/ui and Tailwind CSS, Zustand, Spring Boot 3.x (Java 21), PostgreSQL, and Flyway[cite: 1]. No deviations allowed.
...
2. **Alignment:** Validate if the solution aligns with the "React + Spring Boot + PostgreSQL" stack and "Modular Monolith" pattern[cite: 1].
