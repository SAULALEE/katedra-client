...
export default function Users() {
  ...
  *{box-sizing:border-box}
  ...
  @media(max-width:820px){
          .kt-details-wrapper { position: absolute !important; right: 0; top: 0; bottom: 0; z-index: 90; box-shadow: -10px 0 40px rgba(0,0,0,0.15); }
          [data-root][data-kt-theme="dark"] .kt-details-wrapper { box-shadow: -10px 0 40px rgba(0,0,0,0.4); }
          [data-root][data-kt-details="true"] .kt-details-wrapper{width:min(320px,90vw)}
